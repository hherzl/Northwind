northwindApp.controller("ProductController", ["$log", "$scope", "$location", "$routeParams", "ProductService", "ngTableParams", "$filter", function ($log, $scope, $location, $routeParams, productService, ngTableParams, $filter) {
    $scope.result = {};
